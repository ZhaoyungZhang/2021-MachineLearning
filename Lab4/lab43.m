clear,clc
train_nums = [1000,2000,3000,4000,5000,6000,7000,8000,9000,10000];% 训练集数目
train_groups = 10;
...
function f = draw_accuracy(accuracy)
    x=1000:1000:10000;
    plot(x,accuracy,'linewidth',3,'Color','r')
    axis([1000 10000 0 1.0])
